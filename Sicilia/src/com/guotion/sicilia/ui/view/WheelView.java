...
import com.guotion.sicilia.ui.adapter.WheelAdapter;
...
public class WheelView extends View {
	...
	public int TEXT_SIZE_VALUE;

	/** Top and bottom items offset (to hide that) */
	private final int ITEM_OFFSET = TEXT_SIZE_ITEM/5;
	...
	public void setItemsTextSize(int size){
		this.TEXT_SIZE_ITEM = size;
		itemsPaint.setTextSize(size);
		
	}
	public void setValueTextSize(int size){
		this.TEXT_SIZE_VALUE = size;
