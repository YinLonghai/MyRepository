...
public class ContactsAdapter extends BaseAdapter {
	...
	public void setList(List<User> searchUsers) {
		this.list = searchUsers;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ContastItemView view;
		if (convertView == null) {
			view = new ContastItemView(context);
			convertView = view;
			convertView.setTag(view);
		} else {
			view = (ContastItemView) convertView.getTag();
		}
